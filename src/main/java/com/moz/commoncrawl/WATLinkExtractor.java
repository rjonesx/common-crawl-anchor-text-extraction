...
public class WATLinkExtractor extends Configured implements Tool {
    ...
    private static final Logger LOG = LoggerFactory
            .getLogger(WATLinkExtractor.class);
    ...
    public static class WATParserMapper
        ...
        protected void map(LongWritable key, WARCWritable value,
            ...
            try {
                ...
                Iterator<JsonNode> links = jsonNode.get("Envelope")
                        .get("Payload-Metadata").get("HTTP-Response-Metadata")
                        .get("HTML-Metadata").get("Links").iterator();
